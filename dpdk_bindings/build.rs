...
fn os_build() -> Result<()> {
    ...
    let bindings: Bindings = builder
        ...
        .allowlist_function("rte_ring_sp_enqueue_burst_elem")
        .allowlist_function("rte_ring_sc_dequeue_burst_elem")
        .allowlist_type("rte_eth_fc_conf")
        .allowlist_type("rte_eth_rxconf")
        .allowlist_type("rte_eth_txconf")
        .allowlist_type("rte_ether_addr")
        ...
        .allowlist_var("RTE_PTYPE_L4_TCP")
        .allowlist_var("RTE_PTYPE_L4_UDP")
        .allowlist_var("RTE_PTYPE_L4_ICMP")
        .clang_arg("-mavx")
        .header("wrapper.h")
        .parse_callbacks(Box::new(bindgen::CargoCallbacks::new()))
        .generate_comments(false)
